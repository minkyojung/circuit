...
export function useTheme() {
  ...
  const [resolvedTheme, setResolvedTheme] = useState<'light' | 'dark' | 'green-light' | 'green-dark' | 'warm-light' | 'warm-dark'>('light');
  ...
  useEffect(() => {
    ...
    let effectiveTheme: 'light' | 'dark' | 'green-light' | 'green-dark' | 'warm-light' | 'warm-dark';
    ...
    root.classList.remove('light', 'dark', 'green-light', 'green-dark', 'warm-light', 'warm-dark');
  ...
  return {
    ...
    toggleTheme: () => {
      ...
      else if (current === 'warm-dark') next = 'system';
      else next = 'light';
      setTheme(next);
    },
  };
