...
import { Copy, Check, FileCode, Bookmark, BookmarkCheck, ChevronDown } from 'lucide-react'
    ...
    <div className="group relative overflow-hidden rounded-lg border border-[#857850]/30 bg-[#857850]/5">
      ...
      <div className="group/header relative">
        ...
        >
          <div className="flex items-center gap-2 text-xs max-w-[300px] truncate">
            <span className="text-[#A89968]/90 truncate">
              {fileName ? (
                <>
                  <span className="font-mono">{fileName}</span>
                  {block.metadata.lineStart && (
                    <span className="ml-1 text-[#A89968]/60">
                      :{block.metadata.lineStart}
                    </span>
                  )}
                </>
      ...
      >
        <div className="overflow-x-auto">
          <pre
            className="p-3 text-[14px] font-extralight leading-relaxed"
            style={{
              margin: 0,
